...
export const requestAllTasks = (listId, query) => dispatch => (
  TaskUtil.fetchTasks(listId, query).then(tasks => dispatch(receiveAllTasks(tasks)))
);
...
export const receiveTaskErrors = taskErrors => ({
